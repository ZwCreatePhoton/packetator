...
class NetworkDevice
{
    public:
        ...
        NetworkDevice(Tins::NetworkInterface networkInterface, std::vector<std::string> all_ipaddresses, std::string ip_address, std::string mask, std::string mac,  std::vector<std::string> mac_blacklist);
#ifdef UNIT_TESTING
