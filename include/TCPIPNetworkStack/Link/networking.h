...
class Networking
{
    public:
        ...
        Tins::Sniffer * GetReciever(const std::string&, const std::string&, std::string ipaddress, const std::vector<std::string>& all_ipaddresses, const std::vector<std::string>& mac_blacklist); //interface name, macaddress, ipaddress
